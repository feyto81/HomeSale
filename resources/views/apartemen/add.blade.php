...
@section('title','Add Apartemen | Home Sale')
@section('content')
<div class="row">
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m6 l6">
              <h5 class="breadcrumbs-title"><span>Add Apartemen</span></h5>
            </div>
      ...
      <div class="col s12">
        <div class="container">
          <div class="seaction">
            ...
            <div class="row">
              <form action="{{url('/admin/apartemen/save')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col s12 m6 l6">
