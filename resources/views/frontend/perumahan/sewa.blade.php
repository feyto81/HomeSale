...
@section('title','Perumahan Sewa | findeo')
@section('content')
<div class="clearfix"></div>
<div class="parallax titlebar"
	data-background="{{asset('frontend/images/single-property-01.jpg')}}"
	data-color="#333333"
...
<div class="container">
	<div class="row sticky-wrapper">
		<div class="col-md-12">
            <form class="" method="GET" action="{{url('perumahan/sewa/search')}}">
			...
			<div class="listings-container list-layout">
                @foreach($perumahansewa as $row)
				<div class="listing-item">
					<a href="{{url('perumahan/sewa/details/'.$row->id)}}" class="listing-img-container">
					...
					<div class="listing-content">
						<div class="listing-title">
							<h4><a href="{{url('perumahan/sewa/details/'.$row->id)}}">{{$row->name}}</a></h4>
							<a href="javascipt:void(0)" class="listing-address">
								<i class="fa fa-map-marker"></i>
								{{$row->address}},{{$row->city}},{{$row->provinsi}}
							</a>

							<a href="{{url('perumahan/sewa/details/'.$row->id)}}" class="details button border">Details</a>
						</div>
