...
@section('title','Apartemen Sale | findeo')
@section('content')
...
<div class="container">
	<div class="row sticky-wrapper">
		<div class="col-md-12">
            <form class="" method="GET" action="{{url('apartemen/sale/search')}}">
			...
			<div class="listings-container list-layout">
                @foreach($apartemensale as $row)
				<div class="listing-item">
					<a href="{{url('apartemen/sale/details/'.$row->id)}}" class="listing-img-container">
					...
					<div class="listing-content">
						<div class="listing-title">
							<h4><a href="{{url('apartemen/sale/details/'.$row->id)}}">{{$row->name}}</a></h4>
							<a href="javascipt:void(0)" class="listing-address">
								<i class="fa fa-map-marker"></i>
								{{$row->address}},{{$row->city}},{{$row->provinsi}}
							</a>

							<a href="{{url('apartemen/sale/details/'.$row->id)}}" class="details button border">Details</a>
						</div>
