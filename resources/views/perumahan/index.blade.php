...
@section('title','List Perumahan | Home Sale')
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m6 l6">
              <h5 class="breadcrumbs-title"><span>Perumahan List</span></h5>
            </div>
...
<script>
  $('.btn-delete').click(function(){
    var perumahan_id = $(this).attr('perumahan-id');
...
swalWithBootstrapButtons.fire({
  ...
  if (result.value) {
    window.location = "/admin/perumahan/destroy/"+perumahan_id+"";
  } else if (
