...
@section('title','Edit Artikel | Home Sale')
@section('content')
<div class="row">
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m6 l6">
              <h5 class="breadcrumbs-title"><span>Edit Artikel</span></h5>
            </div>
                  ...
                  <div id="prefixes" class="card card card-default scrollspy">
                    <div class="card-content">
                        <h4 class="card-title"></h4>
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                                <textarea id="content" name="content" class="materialize-textarea">{{$artikel->content}}</textarea>
