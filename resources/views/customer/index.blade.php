...
@section('title','List Customer | Home Sale')
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m6 l6">
              <h5 class="breadcrumbs-title"><span>Customer List</span></h5>
            </div>
                          ...
                          <tbody>
                            @foreach($customer as $row)
                                <tr>
                                    ...
                                    <td>{{$row->kodepos}}</td>
                                    <td>
                                      <a href="{{url('admin/customer/edit/'.$row->id)}}" title="Edit" class="btn-floating mb-1 btn-small btn-flat waves-effect waves-light amber accent-2 white-text">
...
swalWithBootstrapButtons.fire({
  ...
  if (result.value) {
    window.location = "/admin/customer/destroy/"+customer_id+"";
  } else if (
